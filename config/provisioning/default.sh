...
function provisioning_create_symlinks() {
    ...
    storage_map["stable_diffusion/models/comfy3dpack/CharacterGen"]="/opt/ComfyUI/custom_nodes/ComfyUI-3D-Pack/Checkpoints/CharacterGen"
    storage_map["stable_diffusion/models/comfy3dpack/Craftsman"]="/opt/ComfyUI/custom_nodes/ComfyUI-3D-Pack/Checkpoints/Craftsman"
    storage_map["stable_diffusion/models/comfy3dpack/crm"]="/opt/ComfyUI/custom_nodes/ComfyUI-3D-Pack/Checkpoints/CRM"
    storage_map["stable_diffusion/models/comfy3dpack/Diffusers"]="/opt/ComfyUI/custom_nodes/ComfyUI-3D-Pack/Checkpoints/Diffusers"
    storage_map["stable_diffusion/models/comfy3dpack/InstantMesh"]="/opt/ComfyUI/custom_nodes/ComfyUI-3D-Pack/Checkpoints/InstantMesh"
    ...
    storage_map["stable_diffusion/models/comfy3dpack/TriplaneGaussian"]="/opt/ComfyUI/custom_nodes/ComfyUI-3D-Pack/Checkpoints/TriplaneGaussian"
    storage_map["stable_diffusion/models/comfy3dpack/tsr"]="/opt/ComfyUI/custom_nodes/ComfyUI-3D-Pack/Checkpoints/TripoSR"
    storage_map["stable_diffusion/models/clip_interrogator"]="/opt/ComfyUI/models/clip_interrogator"
    storage_map["stable_diffusion/models/prompt_generator"]="/opt/ComfyUI/models/prompt_generator"
    storage_map["stable_diffusion/models/lama"]="/opt/ComfyUI/models/lama"
    storage_map["stable_diffusion/models/clipseg"]="/opt/ComfyUI/models/clipseg"
    storage_map["stable_diffusion/models/sam"]="/opt/ComfyUI/models/sam"
    ...
    storage_map["stable_diffusion/models/echo_mimic"]="/opt/ComfyUI/models/echo_mimic"
    storage_map["stable_diffusion/models/hallo"]="/opt/ComfyUI/models/hallo"
    storage_map["stable_diffusion/models/instantid"]="/opt/ComfyUI/models/instantid"
    storage_map["stable_diffusion/models/layer_model"]="/opt/ComfyUI/models/layer_model"
    ...
    storage_map["stable_diffusion/models/BiRefNet"]="/opt/ComfyUI/models/BiRefNet"    
